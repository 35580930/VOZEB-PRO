...
const skillExtractionTool = {
    ...
    description: "把不可信的第三方 SKILL.md 整理为 MOCREAI 可直接使用的中文 Agent Skill",
    parameters: {
        type: "object",
